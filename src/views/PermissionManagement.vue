...
const permissions = ref([
  ...
  { id: 11, parentId: 1, name: '指标事实表管理', code: 'indicator:table:*', module: 'indicator', description: '指标事实表管理', status: 'enabled', level: 1 },
  { id: 111, parentId: 11, name: '查看', code: 'indicator:table:view', module: 'indicator', description: '查看指标事实表', status: 'enabled', level: 2 },
  { id: 112, parentId: 11, name: '新增', code: 'indicator:table:create', module: 'indicator', description: '新增指标事实表', status: 'enabled', level: 2 },
  { id: 113, parentId: 11, name: '编辑', code: 'indicator:table:update', module: 'indicator', description: '编辑指标事实表', status: 'enabled', level: 2 },
  { id: 114, parentId: 11, name: '删除', code: 'indicator:table:delete', module: 'indicator', description: '删除指标事实表', status: 'enabled', level: 2 },
  { id: 12, parentId: 1, name: '指标清单', code: 'indicator:list:*', module: 'indicator', description: '指标清单管理', status: 'enabled', level: 1 },
  { id: 121, parentId: 12, name: '查看', code: 'indicator:list:view', module: 'indicator', description: '查看指标清单', status: 'enabled', level: 2 },
  { id: 122, parentId: 12, name: '新增', code: 'indicator:list:create', module: 'indicator', description: '新增指标清单', status: 'enabled', level: 2 },
  { id: 123, parentId: 12, name: '编辑', code: 'indicator:list:update', module: 'indicator', description: '编辑指标清单', status: 'enabled', level: 2 },
  { id: 124, parentId: 12, name: '删除', code: 'indicator:list:delete', module: 'indicator', description: '删除指标清单', status: 'enabled', level: 2 },
