...
const indicators = ref([
  ...
  },
  {
    ...
    formula: 'COUNT(DISTINCT [用户表.用户ID])',
    currentValue: 18500,
  ...
  },
  {
    ...
    formula: 'SUM([销售明细表.销售金额]) / COUNT([销售明细表.订单ID])',
    currentValue: 488.28,
  ...
  },
  {
    ...
    formula: 'COUNT([退款表.退款订单ID]) / COUNT([销售明细表.订单ID])',
    currentValue: 0.025,
